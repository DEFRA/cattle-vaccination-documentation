...
![Stage 2 — Deployment](../structure-view/images/evolution/cvac_evolution_2_test_viewing_deployment.png)
...
![Stage 3 — SICCT Testing (Vet Portal)](../structure-view/images/evolution/cvac_evolution_3_sicct_ui.png)

#### Deployment

![Stage 3 — Deployment](../structure-view/images/evolution/cvac_evolution_3_sicct_ui_deployment.png)

---

### Stage 4 — SICCT Testing (VDP API)

Adds a new External API so that Veterinary Delivery Partner systems (e.g. UK FarmCare TOM) can retrieve workorders and submit test results programmatically, complementing the vet portal from Stage 3.

![Stage 4 — SICCT Testing (VDP API)](../structure-view/images/evolution/cvac_evolution_4_sicct_api.png)

#### Deployment

![Stage 4 — Deployment](../structure-view/images/evolution/cvac_evolution_4_sicct_api_deployment.png)
...
![Stage 5 — Vaccination with Vet Portal](../structure-view/images/evolution/cvac_evolution_5_vax.png)

#### Deployment

![Stage 5 — Deployment](../structure-view/images/evolution/cvac_evolution_5_vax_deployment.png)
...
![Stage 6 — Public Vaccination Status](../structure-view/images/evolution/cvac_evolution_6_vax_public_status.png)

#### Deployment

![Stage 6 — Deployment](../structure-view/images/evolution/cvac_evolution_6_vax_public_status_deployment.png)
